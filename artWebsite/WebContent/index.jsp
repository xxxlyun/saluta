    ...
    <div class="row">
      ...
      <div class="col-xs-6111">
        ...
        <s:if test="#session.user==null">
          ...
          <s:else>
          <li>  <a href="personal.jsp"><span class="glyphicon glyphicon-user"></span>     
                                      亲爱的<s:property value="#session.user.role.role_name" />:
               <s:property value="#session.user.username" /></a></li>
               <li> <a href="logoutAction">退出
				</a> </li>
		 </s:else>
        </ul>
      </div>
    ...
    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel"> 
      ...
      <div class="carousel-inner">
        <div class="item active">
            <!-- Static Header --> 
            <img src="images/yh3.jpg" alt="First slide">
  ...
  <div class="col-lg-12">
    <div class="heading">
      <h2>拍卖专场</h2>
       ...
       <div class="xxg-gdzc"  >
				 <div class="xxg-gdzc-img"><a href="/paimai/gaoduan-1"><img alt="高端艺术品竞拍专场" src="images/back2.jpg" class="img2"/></a></div>
...
<div class="row">
				<div class="xxg-gdzc-img" >
                <div style=" float:center; border-style:dotted; border-color:#FFF;padding:20px">
					
						<img src="images/jp2.jpg" class="img2"/>
                </div>
                </div>
			</div>
